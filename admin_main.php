...
<div class="container">
	<br><br>
	<h4 class="mb-5 text-center"><strong>Enter updates</strong></h4>
<br><br>
          ...
          <div class="col-md-6">
            <form method="post" action="newsUpdates.php" enctype="multipart/form-data">
             ...
             <div class="form-outline  mb-4">
              ...
              <div class="form-outline">
                <textarea class="form-control" id="textAreaExample" onkeyup="countChar(this)" name="desc" rows="4"></textarea>
